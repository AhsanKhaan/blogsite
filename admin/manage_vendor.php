	...
	<div class="col-md-6 catname-group">
		<div class="form-group catname-group">
			<label class="control-label" for="vendor_name">Vendor Name</label>
				<input type="text" <?php echo TypeLength(); ?> id="vendor_name" name="vendor_name" class="form-control" placeholder="Category Name" value="<?php echo $CategeryData['category_name'] ?? null; ?>">
		</div>
	</div>
