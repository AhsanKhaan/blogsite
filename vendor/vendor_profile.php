          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Qasim</h3>

                <p class="text-muted text-center">Bird whole Seller</p>
                    ...
                    <form class="form-horizontal">
                      ...
                      <div class="form-group row">
                       <label for="inputExperience" class="col-sm-2 col-form-label">Description</label>
                        <div class="col-sm-10">
                          <textarea class="form-control" id="inputExperience" placeholder="Enter your Description"></textarea>
                        </div>
                      </div>
                      <div class="form-group row">
